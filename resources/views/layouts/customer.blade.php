    ...
    <body class="@yield('body-class')" >
        <div id="page" class="hfeed site">
            ...
            <div class="top-bar top-bar-v1">
                <div class="col-full">
                    <ul id="menu-top-bar-left" class="nav justify-content-center">
                        ...
                        <li class="menu-item animate-dropdown">
                            <a title="Quality Guarantee of products" href="javascript:viod(0)"><i class="fa fa-envelope-o" aria-hidden="true"></i> info@skipoutlet.com</a>
                        </li>
                        <li class="menu-item animate-dropdown">
            ...
            <header id="masthead" class="site-header header-v1" style="background-image: none; padding: 0px !important">
                ...
                <div class="col-full desktop-only" style="background-color: #94004f; width: 100%">
                    ...
                    <div class="row align-items-center" style="padding: 10px">
                        ...
                        <div id="departments-menu" class="dropdown departments-menu">
                            ...
                            <button class="btn dropdown-toggle btn-block" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white">
                        ...
                        <ul id="site-header-cart" class="site-header-cart menu">
                            <li class="animate-dropdown dropdown " style="display: inline-block">
                                <a class="cart-contents" href="{{ url('/cart') }}" data-toggle="dropdown" title="View your shopping cart">
                                    <i class="tm tm-shopping-bag" style="color: white"></i>
                ...
                <div class="col-full desktop-only" style="background-color: #ed017f; width: 100%">
                    
                        <div class="row" style="background-color: #ed017f;">
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#" aria-expanded="false" style="color: white">All Stores<span class="caret"></span></a>
                                        <ul role="menu" class=" dropdown-menu">
                                            <li class="menu-item animate-dropdown">
                                                <a title="ALl Stores" href="{{ url('/stores') }}">All Stores</a>
                                            </li>
                                            @foreach($supermarkets as $supermarket)
                                                <li class="menu-item animate-dropdown">
                                                    <a title="{{ $supermarket->name }}" href="{{ url('/store', [$supermarket->slug]) }}">{{ $supermarket->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                        <!-- .dropdown-menu -->
                                    ...
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#" aria-expanded="false" style="color: white">Categories<span class="caret"></span></a>
                                        <ul role="menu" class=" dropdown-menu">
                                            <li class="menu-item animate-dropdown">
                                    ...
                                    <li class="menu-item animate-dropdown">
                                        <a href="{{ url('/products') }}" style="color: white">Products</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#" aria-expanded="false" style="color: white">Agents<span class="caret"></span></a>
                                        <ul role="menu" class=" dropdown-menu">
                                            <li class="menu-item animate-dropdown">
                                                <a title="All Agents" href="{{ url('agent/all_agents') }}">All Agents</a>
                                            </li>
                                            <li class="menu-item animate-dropdown">
                                                <a title="Become An Agent" href="{{ url('agent/become_an_agent') }}">Become An Agent</a>
                                            </li>
                                        </ul>
                                        <!-- .dropdown-menu -->
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a href="{{ url('/contact_us') }}" style="color: white">Contact Us</a>
                                    </li>
                                    @guest
                                        <li class="menu-item">
                                            <i class="tm tm-login-register"></i>
                                            <a class="" href="{{ url('/register') }}" style="color: white">Register</a>
                                            <span>OR</span>
                                            <a class="" href="{{ url('/login') }}" style="color: white">Login</a>
                                        </li>
                                    @endguest
                                    <li class="techmarket-flex-more-menu-item dropdown">
                                        <a title="..." href="#" data-toggle="dropdown" class="dropdown-toggle" style="color: white" style="background-color: #ed017f">...</a>
                                        <ul class="overflow-items dropdown-menu" style="background-color: #ed017f"></ul>
                                        <!-- . -->
                                    </li>
                                </ul>
                                <!-- .nav -->
            ...
            <footer class="site-footer footer-v1" style="background-color: black">
                <div class="col-full">
                        ...
                        <div class="row">
                            <div class="footer-contact">
                                <div class="footer-logo">
                                    <a href="{{ url('/') }}" class="custom-logo-link" rel="home">
                                        <img width="100px" src="{{ asset('customer\images\logo-white.png') }}" alt=">
                                    </a>
                                </div>
                                <!-- .footer-logo -->
                                    ...
                                    <div class="footer-contact-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <span class="y text-white">07043434010, info@skipoutlet.com </span><br>
                    ...
                    <div class="site-info">
                        <div class="col-full">
                            <div class="copyright">Copyright © Skip Outlet Limited {{date('Y')}} <a href="javascript:void(0)"></div>
                            <!-- .copyright -->
